...
class App extends Component {
	...
	watchLogs() {
		...
		/// save reference to global Component object for later user
		var that = this
	...
	render() {
		return (
			<div className="body">
				...
				<h3>
					Here you'll see events logged by the multi-sig contract you
					implemented. First click the button below. Behind the scenes this is
					sending ether to the multi-sig contract. Accordingly, we'll see the
					DepositFunds event logged below.
				</h3>
				<ul>
				...
				<button onClick={this.sendEther} className="ether-btn">
					Send Ether
				</button>
			</div>
		)
